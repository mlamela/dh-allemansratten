...
Methodologically, the project combines computational analysis of bilingual textual corpora (parliamentary sources, newspapers) with the use of archival material (court cases, association sources). The computational analysis involves working with large-scale digitised text collections using methods such as conceptual and thematic analysis. The project collaborates on the digitisation of the minutes of the Finnish Diet of Estates (1863-1906) with the SWERIK (Swedish Riksdag 1867–2022) research project ([https://swerik-project.github.io/](https://swerik-project.github.io/)). By combining large-scale digital analysis with qualitative historical interpretation, the project also contributes to methodological discussions in digital history, particularly regarding the use of multilingual corpora.
